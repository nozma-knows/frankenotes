...
export default function ColorPicker({
  ...
  return (
      ...
      >
        ...
        <div className="flex flex-wrap justify-center w-full gap-2">
          {basicColors.map((basicColor) => (
            <button
              className={`flex border rounded-sm h-6 w-6 cursor-pointer list-none ${
                basicColor === selfColor.hex && "shadow-xl"
              }`}
              key={basicColor}
        ...
        <MoveWrapper
          className="w-full relative my-3 h-[150px] select-none"
          style={{
    ...
    linear-gradient(to right, white, transparent)`,
        ...
        >
          <div
            className="absolute w-4 h-4 border-2 rounded-xl shadow-xl	box-bordertranslate-y-[-10px] translate-x-[-10px]"
            style={{
        ...
        <MoveWrapper
          className="w-full relative mb-3 h-4"
          style={{
        ...
        >
          <div
            className="absolute w-5 h-5 border-2 rounded-xl shadow-xl	box-bordertranslate-y-[-4px] translate-x-[-10px]"
            style={{
              backgroundColor: `hsl(${selfColor.hsv.h}, 100%, 50%)`,
              left: huePosition.x,
            }}

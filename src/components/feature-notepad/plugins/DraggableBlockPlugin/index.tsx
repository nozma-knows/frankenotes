...
function isOnMenu(element: HTMLElement): boolean {
  return !!element.closest("draggable-block");
}
  ...
  return createPortal(
    <>
      <div
        ...
        onDragEnd={onDragEnd}
      >
        <BsArrowsMove className={isEditable ? "icon" : ""} />
      </div>
      {/* <div className="draggable-block-target-line" ref={targetLineRef} /> */}
      <div
        className="pointer-events-none	bg-blue-600 h-2 absolute left-0 top-0 opacity-0 will-change-transform"
        ref={targetLineRef}
      />
    </>,
    anchorElem
